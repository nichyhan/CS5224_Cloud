...
public class WordCount {
  ...
  public static class Map 
    ...
    private final static IntWritable one = new IntWritable(500); // type of output value
    private Text word = new Text();   // type of output key
...
public static void main(String[] args) throws Exception {
    ...
    MultipleInputs.addInputPath(job, otherArgs[0], TextInputFormat.class, Map.class);
    MultipleInputs.addInputPath(job, otherArgs[2], TextInputFormat.class, Map2.class);
